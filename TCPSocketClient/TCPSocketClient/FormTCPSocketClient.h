...
namespace TCPSocketClient {
	...
	private: static const int PORT = 8003;
	private: static const int MAX_BUF_SIZE = 255;
	private: static const int RCV_TIME_OUT = 1000000; // in milliseconds
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->TextBoxIpAddress->Text = L"129.105.90.71";
			// 
			// label8
			// 
			...
			// ButtonRun
			// 
			this->ButtonRun->Location = System::Drawing::Point(158, 290);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(33, 290);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(284, 290);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
       ...
       //HINSTANCE hInstance = ShellExecute(NULL, "open", "C:\Users\sooding\Desktop\SocketSniff.exe", NULL, NULL, SW_SHOW);
		 Process::Start("C:\\Users\\sooding\\Desktop\\SocketSniff.exe" );
		 }
};
}
